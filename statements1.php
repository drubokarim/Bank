...
<form>
	<fieldset class="Pos">
		<input type="submit"  style="font-size: 100%;" id="button" value="Speicific Account statement" formaction="http://localhost/wt/statements.php">
	    <input type="submit" style="font-size: 100%;color:black;" id="button" value="All Account Trasaction" formaction="http://localhost/wt/statements1.php">
        <form>
        	<fieldset>
